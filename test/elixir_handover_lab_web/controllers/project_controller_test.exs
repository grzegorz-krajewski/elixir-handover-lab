defmodule ElixirHandoverLabWeb.ProjectControllerTest do
  use ElixirHandoverLabWeb.ConnCase

  import ElixirHandoverLab.HandoverFixtures

  @create_attrs %{name: "some name", status: "some status", description: "some description", source_language: "some source_language", framework: "some framework", repository_url: "some repository_url"}
